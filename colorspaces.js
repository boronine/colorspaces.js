(function() {
  (function() {
    var conv, converter, dot_product, exports, f, f_inv, lab_e, lab_k, polar_to_scalar, ref_U, ref_V, ref_X, ref_Y, ref_Z, root, round, sRGB_prepare, scalar_to_polar, stylus, within_range;
    ...
    sRGB_prepare = function(tuple) {
      var ch, n, _i, _j, _len, _len2, _results;
      tuple = (function() {
        var _i, _len, _results;
        _results = [];
      ...
      _results = [];
      for (_j = 0, _len2 = tuple.length; _j < _len2; _j++) {
        ch = tuple[_j];
      ...
      exports = module.exports = function() {
        ...
        return function(style) {
          ...
          for (_i = 0, _len = spaces.length; _i < _len; _i++) {
            space = spaces[_i];
            _results.push(style.define(space, function(a, b, c) {
              var foo, g, r, _ref;
    ...
    root = exports != null ? exports : {};
    root.converter = converter;
    return root.make_color = function(space1, tuple) {
      return {
        as: function(space2) {
          var val;
