...
(function() {
  var conv, converter, dot_product, f, f_inv, from_linear, lab_e, lab_k, m, m_inv, maxChroma, polar_to_scalar, ref_U, ref_V, ref_X, ref_Y, ref_Z, root, round, sRGB_prepare, scalar_to_polar, stylus, to_linear, within_range;
  ...
  maxChroma = function(L, H) {
    var bottom, cosH, hrad, i, lbottom, m1, m2, m3, rbottom, res, result, sinH, sub1, sub2, top, _i, _len, _ref, _ref1;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      i = _ref[_i];
      _ref1 = m[i], m1 = _ref1[0], m2 = _ref1[1], m3 = _ref1[2];
  ...
  conv['LSH']['CIELCHuv'] = function(tuple) {
    var max, _C, _L, _S, _h;
    _L = tuple[0], _S = tuple[1], _h = tuple[2];
    max = maxChroma(_L, _h);
    _C = max / 100 * _S;
    return [_L, _C, _h];
  };

  conv['CIELCHuv']['LSH'] = function(tuple) {
    var max, _C, _L, _S, _h;
    _L = tuple[0], _C = tuple[1], _h = tuple[2];
    max = maxChroma(_L, _h);
    _S = _C / max * 100;
  ...
  converter = function(from, to) {
    var func, path, tree;
    tree = [['CIELCH', 'CIELAB'], ['LSH', 'CIELCHuv'], ['CIELCHuv', 'CIELUV'], ['hex', 'sRGB'], ['CIExyY', 'CIEXYZ'], ['CIELAB', 'CIEXYZ'], ['CIELUV', 'CIEXYZ'], ['sRGB', 'CIEXYZ']];
