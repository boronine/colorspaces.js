...
(function() {
  var conv, converter, dot_product, f, f_inv, lab_e, lab_k, m, maxChroma, polar_to_scalar, ref_U, ref_V, ref_X, ref_Y, ref_Z, root, round, sRGB_prepare, scalar_to_polar, stylus, to_linear, within_range;
  ...
  maxChroma = function(L, H) {
    var C, H_rad, cos, i, num, result, sin, sub1, sub2, sub3, sub4, _i, _j, _len, _len1, _ref, _ref1;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        ...
        C = (ref_V * sub3 - dot_product(m[i], [sub2, ref_V, sub1])) / (dot_product(m[i], [cos * 2.25, sin, -cos * 0.75 - sin * 5]) - sin * sub3) * 13 * L;
        if (C > 0) {
